...
class TestAskForm(unittest.TestCase):
    def test_from(self):
        ...
        assert isinstance(text, forms.CharField), "title field is not an instance of forms.CharField"
...
class TestAnswerForm(unittest.TestCase):
    def test_from(self):
        ...
        assert isinstance(question, (forms.IntegerField, forms.ChoiceField)), "author field is not an instance of IntegerField or ChoiceField"
